/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface=CloudflareEnv ./cloudflare-env.d.ts` (hash: 5c51391253f92a68218a33ead99b533b)
// Runtime types generated with workerd@1.20260925.1 2026-09-25 nodejs_compat
interface __BaseEnv_CloudflareEnv {
	...
	ASSETS: Fetcher;
	APP_ENV?: "preview";
	EMAIL_FROM: "Swiss3Design Preview <commandes@swiss3design.ch>" | "Swiss3Design <commandes@swiss3design.ch>";
	STRIPE_PAYMENT_METHOD_CONFIGURATION: "" | "pmc_1TgkcKK4o7ey3lG5alpRZU3l";
	STRIPE_PUBLISHABLE_KEY: "pk_test_51TgkbnK4o7ey3lG5CAqK0NBqFazy43LthNOQ0IKgmiTwv6ni7Cd4yiuaM6M0gb5XHF3HI4PAlYCFlqFr9BNIMND000iDY9eEiF" | "pk_live_51TgkbnK4o7ey3lG5X2NE0ujxVeMTP1YdHK6gxgefCazQEeX6m5MMDAWPJKWMndMXrcS6tvxR8oXMJ00AxPqnJARb00q2dn8APu";
	...
	CRON_SECRET: string;
	WORKER_SELF_REFERENCE: Fetcher /* swiss3design-preview */ | Service<typeof import("./.open-next/worker").default>;
}
declare namespace Cloudflare {
	...
	interface PreviewEnv {
		...
		FACEBOOK_CLIENT_SECRET: string;
		CRON_SECRET: string;
		WORKER_SELF_REFERENCE: Fetcher /* swiss3design-preview */;
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "APP_ENV" | "EMAIL_FROM" | "STRIPE_PAYMENT_METHOD_CONFIGURATION" | "STRIPE_PUBLISHABLE_KEY" | "STRIPE_SECRET_KEY" | "STRIPE_WEBHOOK_SECRET" | "BETTER_AUTH_SECRET" | "BETTER_AUTH_URL" | "ADMIN_EMAILS" | "DATABASE_URL" | "RESEND_API_KEY" | "GOOGLE_CLIENT_ID" | "GOOGLE_CLIENT_SECRET" | "APPLE_CLIENT_ID" | "APPLE_CLIENT_SECRET" | "FACEBOOK_CLIENT_ID" | "FACEBOOK_CLIENT_SECRET" | "CRON_SECRET">> {}
}
...
declare namespace CloudflareWorkersModule {
    ...
    export abstract class WorkerEntrypoint<Env = Cloudflare.Env, Props = {}> implements Rpc.WorkerEntrypointBranded {
        ...
        tailStream?(event: TailStream.TailEvent<TailStream.Onset>): TailStream.TailEventHandlerType | undefined | Promise<TailStream.TailEventHandlerType | undefined>;
...
declare namespace TailStream {
    ...
    type EventType = Onset | Outcome | SpanOpen | SpanClose | SpanUpdate | DiagnosticChannelEvent | Exception | Log | StreamDiagnostic | Return | Attributes;
