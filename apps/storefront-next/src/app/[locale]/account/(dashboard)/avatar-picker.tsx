...
const AVATARS = Array.from({ length: 10 }, (_, i) => `/avatars/a${String(i + 1).padStart(2, "0")}.svg`);
    ...
    <div ref={ref} className="relative">
      ...
      >
        {current ? (
          ...
          <img src={current} alt="" referrerPolicy="no-referrer" className="h-12 w-12 rounded-full object-cover ring-1 ring-line" />
        ) : (
            ...
            {AVATARS.map((a) => (
              <button
                ...
                className={`overflow-hidden rounded-full ring-2 ring-offset-2 ring-offset-surface transition-all hover:scale-105 ${
                  current === a ? "ring-accent" : "ring-transparent hover:ring-line"
