...
// miroir de src/lib/stripe-appearance.ts côté app Next.js. Sélecteurs tous
// documentés par l'Appearance API (.Input, .Label, .Error, .AccordionItem,
// .Dropdown…) — un sélecteur non supporté ferait échouer le rendu.
