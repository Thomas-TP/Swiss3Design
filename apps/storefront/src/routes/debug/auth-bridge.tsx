// Banc de test du pont d'authentification Better Auth -> Medusa (Phase 4),
// conservé pour re-vérification future — les vraies pages de connexion
// vivent désormais sous /[locale]/account/*.
...
export default function AuthBridgeDebugPage() {
  ...
  return (
    <main class="mx-auto max-w-2xl p-8 text-center font-sans">
      <h1 class="text-3xl font-bold text-red-600">Debug — pont auth</h1>
